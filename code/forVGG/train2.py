...
# 生成tensorboard可视化文件
from torch.utils.tensorboard import SummaryWriter
writer = SummaryWriter(log_dir='./tensorboard event file', filename_suffix=str(40),flush_secs = 180)
...
def main():
    ...
    image_path = os.path.join(data_root, "code/forVGG", "data")  # flower data set path
