...
for i in range(1000):
    ...
    maskss = ' --mask /home/lws/after_train_test/mask_fan_se/' + str(xx+1) + 'qj.png'
    imgss = "python test.py --image /home/lws/instances_train_folder/instances_train/instances_train/" + ss1 + '.jpg'
    restss = " --output /home/lws/after_train_test/qj_output/output_" + ss1 + ".jpg --checkpoint_dir logsss/full_model_places2_256"
