...
if __name__ == '__main__':
    ...
    parser.add_argument('--deep_sort_model', type=str, default='osnet_ibn_x1_0_market1501_256x128_amsgrad_ep150_stp60_lr0.0015_b64_fb10_softmax_labelsmooth_flip_jitter')
    ...
    parser.add_argument('--save-vid', default='1', action='store_true', help='save video tracking results')
    parser.add_argument('--save-txt', default='1', action='store_true', help='save MOT compliant results to *.txt')
    ...
    parser.add_argument('--exist-ok', action='store_true',default='1', help='existing project/name ok, do not increment')
