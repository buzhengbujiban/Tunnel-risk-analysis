# -*- coding: utf-8 -*-
"""
Created on Tue Jan 25 13:08:39 2022
...
'''
# 原coco数据集的路径
dataDir = "/data/TsinghuaMOCS/"
# 用于保存新生成的mask数据的路径
#savepath = "/data/TsinghuaMOCS/coco_mask/"
#savepath = "./"
'''
数据集参数
'''
...
# 其他没写的会被当做背景变成黑色
classes_names = ["Worker","Static crane","Hanging head","Crane","Roller","Bulldozer","Excavator","Truck","Loader","Pump truck","Concrete mixer","Pile driving","Other vehicle"]
...
if __name__ == '__main__':
    ...
    # 用来保存最后生成的mask图像目录
        ...
        mask_to_save = '/home/lws/GracoNet-Object-Placement/result'  # 三通道mask图存储路径
